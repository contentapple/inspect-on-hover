    ...
    public class Mod : MonoBehaviour
    {
        ...
        public static void Main()
        {
            ...
            try
            {
                ...
                if (entryType == null)
                {
                    ModAPI.Notify("Sticky loader: entry type missing");
                    return;
                }
                ...
                if (entry == null)
                {
                    ModAPI.Notify("Sticky loader: entry method missing");
                    return;
                }
            ...
            {
                ModAPI.Notify("Sticky loader: " + ex.Message);
            }
        }
    }
}
